...
import 'package:customersuppert_admin/Theme/colors.dart';
import 'package:customersuppert_admin/WIdgets/myMessageBox.dart';
import 'package:customersuppert_admin/WIdgets/peerMessageBox.dart';
...
class ChatScreen extends StatefulWidget {
  final String adminId, userID,peerName;

  ChatScreen({Key key, @required this.userID, @required this.adminId,@required this.peerName})
      : super(key: key);
